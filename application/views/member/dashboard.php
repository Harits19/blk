                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped table-hover table-condensed">
                        ...
                        <tbody id="myTable">
                            ...
                            ?>
                              <td> 
                              <button class="btn btn-primary" id="button_detail" data-toggle="modal" href="#myModalDetail" 
                              ...
                              >Detail</button> 
                              <br><br>
                              <button class="btn btn-primary" id="button_daftar" data-toggle="modal" href="#myModalDaftar" 
                              data-id_pelatihan="<?php echo $pelatihan->id ?>">Daftar</button>
