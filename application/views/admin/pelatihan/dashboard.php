                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped table-hover table-condensed">
                        ...
                        <tbody>
                            ...
                            ?>
                                <a class="btn btn-primary" id="button_edit" data-toggle="modal" href="#myModalEdit" 
                                data-nama="<?php echo $pelatihan->nama ?>" 
                                data-tgl_buka="<?php echo $pelatihan->tgl_buka ?>" 
                                data-tgl_tutup="<?php echo $pelatihan->tgl_tutup ?>" 
                                data-tgl_buka="<?php echo $pelatihan->tgl_buka ?>" 
                                data-detail_pelatihan="<?php echo $pelatihan->detail_pelatihan ?>" 
                                data-nama_pelatih="<?php echo $pelatihan->nama_pelatih ?>" 
                                data-kontak_pelatih="<?php echo $pelatihan->kontak_pelatih ?>"
                                data-tgl_verifikasi="<?php echo $pelatihan->tgl_verifikasi ?>"
                                data-tgl_verifikasi_cadangan="<?php echo $pelatihan->tgl_verifikasi_cadangan ?>"
                                data-status="<?php echo $pelatihan->status ?>"
                                data-kuota_kota="<?php echo $pelatihan->kuota_kota ?>"
                                data-kuota_luar_kota="<?php echo $pelatihan->kuota_luar_kota ?>"
                                data-id="<?php echo $pelatihan->id ?>"
                                >Edit</a>
